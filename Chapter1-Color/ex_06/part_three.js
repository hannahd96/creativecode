...
// actions and their corresponding buttons
function keyPressed() {
  ...
  if (key == 'c' || key == 'C') {
	...
	// if 1 is pressed, change hue, saturation and brightness
  if (key == '1') {
    for (var i = 0; i < tileCountX; i++) {
      hueValues[i] = random(360);
      saturationValues[i] = random(100);
...
// if 2 is pressed, change hue, saturation and brightness
  if (key == '2') {
    for (var i = 0; i < tileCountX; i++) {
      hueValues[i] = random(360);
      saturationValues[i] = random(100);
...
// if 3 is pressed, change hue, saturation and brightness
  if (key == '3') {
    for (var i = 0; i < tileCountX; i++) {
      hueValues[i] = random(360);
...
// if 4 is pressed, change hue, saturation and brightness
  if (key == '4') {
    for (var i = 0; i < tileCountX; i++) {
      hueValues[i] = 0;
...
// if 9 is pressed, change hue, saturation and brightness
// else change to another set of values
  if (key == '9') {
    for (var i = 0; i < tileCountX; i++) {
      if (i % 2 == 0) {
        hueValues[i] = random(360);
...
// if 0 is pressed, change hue, saturation and brightness
// else change to another set of values
  if (key == '0') {
    for (var i = 0; i < tileCountX; i++) {
      if (i % 2 == 0) {
